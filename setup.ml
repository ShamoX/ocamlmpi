...
(* OASIS_START *)
(* DO NOT EDIT (digest: 768b39243e2a1919787304552883c7a8) *)
(*
...
(* # 21 "/home/berenger/.opam/4.00.0+fp/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml" *)
...
let setup_t =
  {
     ...
     build =
       CustomPlugin.Build.main
         {
            CustomPlugin.cmd_main =
              [(OASISExpr.EBool true, ("make", ["all"; "opt"]))];
            cmd_clean = [(OASISExpr.EBool true, None)];
            cmd_distclean = [(OASISExpr.EBool true, None)];
            };
     test = [];
     ...
     package =
       {
          ...
          homepage = Some "http://pauillac.inria.fr/~xleroy/software.html";
          synopsis = "OCaml binding to the Message Passing Interface (MPI)";
          description = None;
          categories = [];
          conf_type = (`Configure, "custom", Some "0.3");
          conf_custom =
            {
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "7\235\0275w\168\222\219\143V\218\177\254\r\190\142";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
